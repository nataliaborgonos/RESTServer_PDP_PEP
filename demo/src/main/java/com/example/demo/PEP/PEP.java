	...
	public PEP(PDP pdp) {
		...
		try {
			schemaRequest = JsonLoader.fromPath(
					"/home/natalia/eclipse-workspace/RESTServer/demo/src/main/java/com/example/demo/models/JSONSchemaRequest.json");
			schemaToken = JsonLoader.fromPath(
					"/home/natalia/eclipse-workspace/RESTServer/demo/src/main/java/com/example/demo/models/JSONSchemaToken.json");
			schemaAccess = JsonLoader.fromPath(
					"/home/natalia/eclipse-workspace/RESTServer/demo/src/main/java/com/example/demo/models/JSONSchemaAccess.json");
		} catch (IOException e) {
